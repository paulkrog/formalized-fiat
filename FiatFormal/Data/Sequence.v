...
Require Import FiatFormal.Data.Monoid.
...
Proof.
 ...
 - intros.
   induction xx; simpl.
   + trivial.
   + rewrite IHxx. unfold compose in *. simpl. trivial.
Qed.
(* PMK: needed to comment out the following to make error free *)
(*    trivial. *)
...
(* The following definition appears earlier in file, not sure why *)
(* Class Functor *)
(*   {F    : Type -> Type} *)
(*   (map  : forall {a b : Type}, (a -> b) -> F a -> F b) *)
(* := { *)
